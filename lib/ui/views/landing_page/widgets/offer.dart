    ...
    children: [
      ...
      Row(
       ...
       mainAxisAlignment: MainAxisAlignment.center,
        children: [
          offerlist(growimg,"GROW","Increase your sales by gaining valuable \n insights from the discussed topics."),
          horizontalSpaceLarge,
          horizontalSpaceLarge,
           offerlist(nlpimg,"NLP MODEL","Let NLP technology work for you\n in uncovering relevant topics."),
          horizontalSpaceLarge,
          horizontalSpaceLarge,
            offerlist(exportimg,"EXPORT","Effortlessly export your extracted \n topics to a .xls file."),

...
class SelectfileDialogDialog extends StackedView<SelectfileDialogDialogModel> {
    ...
    return Dialog(
      ...
      child: Padding(
        ...
        child: SizedBox(
          ...
          width: 400,
          child: Column(
            mainAxisSize: MainAxisSize.min, // Keeps the dialog content compact
  ...
  SelectfileDialogDialogModel viewModelBuilder(BuildContext context) =>
      SelectfileDialogDialogModel(request.data['fileBytes'],
          request.data['fileName'], request.data['sizeInMb']);
}
